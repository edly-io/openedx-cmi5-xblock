...
class CMI5XBlock(XBlock):
    ...
    def student_view(self, context=None):
        """
        The primary view of the CMI5XBlock, shown to students
        when viewing courses.
        """
        if context:
            pass  # TO-DO: do something based on the context.
        html = self.resource_string("static/html/openedx_cmi5_xblock.html")
